...
const templates = {
  ...
  '05-relance': {
    ...
    body: [
      ...
      { type: 'spacer', size: 16 },
      { type: 'highlight', body: `<strong style="color:#2BB5FF;">Pro à 9,90 € le premier mois.</strong> Puis 19,90 €/mois. Annulable à tout moment, sans frais.` },
      { type: 'spacer', size: 24 },
      { type: 'cta', label: 'Continuer avec SlideAI', url: '{{PRO_INTRO_URL}}' },
      { type: 'spacer', size: 14 },
  ...
  '06-conversion': {
    ...
    body: [
      ...
      { type: 'spacer', size: 16 },
      { type: 'highlight', body: `<strong style="color:#2BB5FF;">Offre de lancement Pro : 9,90 € le premier mois,</strong> puis 19,90 €/mois. Annulable à tout moment.` },
      { type: 'spacer', size: 24 },
      { type: 'features', items: [
      ...
      { type: 'spacer', size: 24 },
      { type: 'cta', label: `Profiter de l'offre`, url: '{{PRO_INTRO_URL}}' },
      { type: 'spacer', size: 24 },
