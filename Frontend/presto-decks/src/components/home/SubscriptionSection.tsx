...
export function SubscriptionSection() {
    ...
    const handleProCta = () => {
        Analytics.trackEvent(
            ...
            ANALYTICS_EVENTS.ECOMMERCE.VIEW_PRICING,
            "Landing Pro CTA"
        );
        navigate("/pricing");
    };
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-secondary/5 rounded-3xl p-8 md:p-12 border border-white/5">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center md:justify-end gap-6">
                        <div className="text-3xl md:text-4xl font-bold">{t('offer.proSubscription.price')}</div>
                        <Button
                            variant="outline"
                            size="lg"
                            onClick={handleProCta}
                            className="h-12 border-primary/20 hover:bg-primary/5 text-lg"
                        >
