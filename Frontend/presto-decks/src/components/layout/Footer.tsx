...
export const Footer = () => {
  ...
  const links = {
    product: [
      ...
      { label: "Exemples presentation IA", href: "/blog/exemples-presentation-ia" },
      { label: "Prompts PowerPoint IA", href: "/blog/prompts-powerpoint-ia" },
      { label: "Slides professionnelles IA", href: "/blog/creer-slides-professionnelles-ia" },
